...
CONF_ADD_CLOUD_LOCK = "add_cloud_lock"
# Замки, которыми можно управлять только через облако: id -> имя и модель.
CONF_CLOUD_LOCKS = "cloud_locks"
...
CONF_NUDGE_TARGET = "nudge_target_on_command"
