...
SENSORS: dict[str, tuple[LocalTuyaEntity, ...]] = {
    ...
    "dgnbj": (
        ...
        LocalTuyaEntity(
            ...
            state_class=SensorStateClass.MEASUREMENT,
            custom_configs=localtuya_sensor(CONCENTRATION_MICROGRAMS_PER_CUBIC_METER),
        ),
        LocalTuyaEntity(
            id=DPCode.CO_VALUE,
            ...
            state_class=SensorStateClass.MEASUREMENT,
            custom_configs=localtuya_sensor(CONCENTRATION_PARTS_PER_MILLION),
        ),
        LocalTuyaEntity(
            id=DPCode.CO2_VALUE,
            # name="carbon_dioxide",
    ...
    "bh": (
        ...
        LocalTuyaEntity(
            ...
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
            custom_configs=localtuya_sensor(UnitOfTemperature.FAHRENHEIT),
        ),
        LocalTuyaEntity(
            id=DPCode.STATUS,
            # name="status",
